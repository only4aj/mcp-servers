...
async def app_lifespan(server: FastMCP) -> AsyncIterator[dict[str, object]]:
    ...
    try:
        ...
        logger.info("Lifespan: Stable Diffusion service cleanup completed successfully.")
...
async def generate_image(
    ...
    prompt: Annotated[
        str,
        Field(description="Text description of the image to generate")
    ],
    ...
    stability_service: StabilityService = ctx.request_context.lifespan_context["stability_service"]
    params = {
        "prompt": prompt,
