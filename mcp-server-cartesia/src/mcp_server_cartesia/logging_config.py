...
log_file_path = os.getenv("MCP_CARTESIA_LOG_FILE", "app.log") # Allow configuring log file path
...
def configure_logging():
    ...
    try:
        ...
        logging.getLogger(__name__).error(f"Failed to apply dictionary logging config: {e}. Falling back to basic config.", exc_info=True)